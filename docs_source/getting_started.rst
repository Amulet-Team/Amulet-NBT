...
.. code-block:: python
   ...
   named_tag = amulet.nbt.read_nbt(b'<nbt file bytes>')  # from a bytes object

   # Note that Java Edition usually uses compressed modified UTF-8.
   java_named_tag = amulet.nbt.read_nbt(
   ...
   bedrock_named_tag = amulet.nbt.read_nbt(
   ...
   tag = amulet.nbt.read_snbt('{key1: "value", key2: 0b, key3: 0.0f}')

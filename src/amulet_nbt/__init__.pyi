...
class CompoundTag(AbstractBaseMutableTag, MutableMapping[str | bytes, AnyNBT]):
    ...
    @overload
    def get_compound(self, key: str | bytes, default: None = None) -> None: ...
    @overload
    def get_byte_array(
        self, key: str | bytes, default: ByteArrayTag = None
    ) -> ByteArrayTag: ...
    @overload
    def get_byte_array(self, key: str | bytes, default: None = None) -> None: ...
    @overload
    def get_int_array(
        self, key: str | bytes, default: IntArrayTag = None
    ) -> IntArrayTag: ...
    @overload
    def get_int_array(self, key: str | bytes, default: None = None) -> None: ...
    @overload
    def get_long_array(
        self, key: str | bytes, default: LongArrayTag = None
    ) -> LongArrayTag: ...
    @overload
    def get_long_array(self, key: str | bytes, default: None = None) -> None: ...
    def setdefault_byte(

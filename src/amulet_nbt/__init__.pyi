...
class CompoundTag(AbstractBaseMutableTag, MutableMapping[str | bytes, AnyNBT]):
    ...
    @overload
    def get_double(self, key: str | bytes, default: None = None) -> DoubleTag | None: ...
    @overload
    def get_string(self, key: str | bytes, default: StringTag = None) -> StringTag: ...
    @overload
    def get_string(self, key: str | bytes, default: None = None) -> StringTag | None: ...
    @overload
    ...
    @overload
    def get_compound(self, key: str | bytes, default: None = None) -> CompoundTag | None: ...
    @overload
    def get_byte_array(
        self, key: str | bytes, default: ByteArrayTag = None
    ) -> ByteArrayTag: ...
    @overload
    def get_byte_array(self, key: str | bytes, default: None = None) -> ByteArrayTag | None: ...
    @overload
    def get_int_array(
        self, key: str | bytes, default: IntArrayTag = None
    ) -> IntArrayTag: ...
    @overload
    def get_int_array(self, key: str | bytes, default: None = None) -> IntArrayTag | None: ...
    @overload
    def get_long_array(
        self, key: str | bytes, default: LongArrayTag = None
    ) -> LongArrayTag: ...
    @overload
    def get_long_array(self, key: str | bytes, default: None = None) -> LongArrayTag | None: ...
    def setdefault_byte(

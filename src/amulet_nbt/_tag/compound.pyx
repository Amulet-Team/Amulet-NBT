...
cdef class CompoundTag(AbstractBaseMutableTag):
    ...
    @overload
    def get_byte(self, key: str | bytes, default: _T) -> amulet_nbt.ByteTag | _T: ...
    @overload
    def get_byte(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ByteTag | _T: ...
    @overload
    def get_byte(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ByteTag: ...
    @overload
    ...
    def get_byte(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ByteTag | _T:
    ...
    @overload
    def pop_byte(self, key: str | bytes, default: _T) -> amulet_nbt.ByteTag | _T: ...
    @overload
    def pop_byte(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ByteTag | _T: ...
    @overload
    def pop_byte(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ByteTag: ...
    @overload
    ...
    def pop_byte(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ByteTag | _T:
    ...
    @overload
    def get_short(self, key: str | bytes, default: _T) -> amulet_nbt.ShortTag | _T: ...
    @overload
    def get_short(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ShortTag | _T: ...
    @overload
    def get_short(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ShortTag: ...
    @overload
    ...
    def get_short(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ShortTag | _T:
    ...
    @overload
    def pop_short(self, key: str | bytes, default: _T) -> amulet_nbt.ShortTag | _T: ...
    @overload
    def pop_short(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ShortTag | _T: ...
    @overload
    def pop_short(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ShortTag: ...
    @overload
    ...
    def pop_short(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ShortTag | _T:
    ...
    @overload
    def get_int(self, key: str | bytes, default: _T) -> amulet_nbt.IntTag | _T: ...
    @overload
    def get_int(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.IntTag | _T: ...
    @overload
    def get_int(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.IntTag: ...
    @overload
    ...
    def get_int(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.IntTag | _T:
    ...
    @overload
    def pop_int(self, key: str | bytes, default: _T) -> amulet_nbt.IntTag | _T: ...
    @overload
    def pop_int(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.IntTag | _T: ...
    @overload
    def pop_int(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.IntTag: ...
    @overload
    ...
    def pop_int(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.IntTag | _T:
    ...
    @overload
    def get_long(self, key: str | bytes, default: _T) -> amulet_nbt.LongTag | _T: ...
    @overload
    def get_long(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.LongTag | _T: ...
    @overload
    def get_long(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.LongTag: ...
    @overload
    ...
    def get_long(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.LongTag | _T:
    ...
    @overload
    def pop_long(self, key: str | bytes, default: _T) -> amulet_nbt.LongTag | _T: ...
    @overload
    def pop_long(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.LongTag | _T: ...
    @overload
    def pop_long(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.LongTag: ...
    @overload
    ...
    def pop_long(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.LongTag | _T:
    ...
    @overload
    def get_float(self, key: str | bytes, default: _T) -> amulet_nbt.FloatTag | _T: ...
    @overload
    def get_float(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.FloatTag | _T: ...
    @overload
    def get_float(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.FloatTag: ...
    @overload
    ...
    def get_float(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.FloatTag | _T:
    ...
    @overload
    def pop_float(self, key: str | bytes, default: _T) -> amulet_nbt.FloatTag | _T: ...
    @overload
    def pop_float(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.FloatTag | _T: ...
    @overload
    def pop_float(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.FloatTag: ...
    @overload
    ...
    def pop_float(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.FloatTag | _T:
    ...
    @overload
    def get_double(self, key: str | bytes, default: _T) -> amulet_nbt.DoubleTag | _T: ...
    @overload
    def get_double(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.DoubleTag | _T: ...
    @overload
    def get_double(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.DoubleTag: ...
    @overload
    ...
    def get_double(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.DoubleTag | _T:
    ...
    @overload
    def pop_double(self, key: str | bytes, default: _T) -> amulet_nbt.DoubleTag | _T: ...
    @overload
    def pop_double(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.DoubleTag | _T: ...
    @overload
    def pop_double(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.DoubleTag: ...
    @overload
    ...
    def pop_double(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.DoubleTag | _T:
    ...
    @overload
    def get_string(self, key: str | bytes, default: _T) -> amulet_nbt.StringTag | _T: ...
    @overload
    def get_string(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.StringTag | _T: ...
    @overload
    def get_string(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.StringTag: ...
    @overload
    ...
    def get_string(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.StringTag | _T:
    ...
    @overload
    def pop_string(self, key: str | bytes, default: _T) -> amulet_nbt.StringTag | _T: ...
    @overload
    def pop_string(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.StringTag | _T: ...
    @overload
    def pop_string(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.StringTag: ...
    @overload
    ...
    def pop_string(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.StringTag | _T:
    ...
    @overload
    def get_list(self, key: str | bytes, default: _T) -> amulet_nbt.ListTag | _T: ...
    @overload
    def get_list(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ListTag | _T: ...
    @overload
    def get_list(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ListTag: ...
    @overload
    ...
    def get_list(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ListTag | _T:
    ...
    @overload
    def pop_list(self, key: str | bytes, default: _T) -> amulet_nbt.ListTag | _T: ...
    @overload
    def pop_list(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ListTag | _T: ...
    @overload
    def pop_list(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ListTag: ...
    @overload
    ...
    def pop_list(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ListTag | _T:
    ...
    @overload
    def get_compound(self, key: str | bytes, default: _T) -> amulet_nbt.CompoundTag | _T: ...
    @overload
    def get_compound(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.CompoundTag | _T: ...
    @overload
    def get_compound(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.CompoundTag: ...
    @overload
    ...
    def get_compound(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.CompoundTag | _T:
    ...
    @overload
    def pop_compound(self, key: str | bytes, default: _T) -> amulet_nbt.CompoundTag | _T: ...
    @overload
    def pop_compound(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.CompoundTag | _T: ...
    @overload
    def pop_compound(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.CompoundTag: ...
    @overload
    ...
    def pop_compound(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.CompoundTag | _T:
    ...
    @overload
    def get_byte_array(self, key: str | bytes, default: _T) -> amulet_nbt.ByteArrayTag | _T: ...
    @overload
    def get_byte_array(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ByteArrayTag | _T: ...
    @overload
    def get_byte_array(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ByteArrayTag: ...
    @overload
    ...
    def get_byte_array(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ByteArrayTag | _T:
    ...
    @overload
    def pop_byte_array(self, key: str | bytes, default: _T) -> amulet_nbt.ByteArrayTag | _T: ...
    @overload
    def pop_byte_array(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.ByteArrayTag | _T: ...
    @overload
    def pop_byte_array(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.ByteArrayTag: ...
    @overload
    ...
    def pop_byte_array(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.ByteArrayTag | _T:
    ...
    @overload
    def get_int_array(self, key: str | bytes, default: _T) -> amulet_nbt.IntArrayTag | _T: ...
    @overload
    def get_int_array(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.IntArrayTag | _T: ...
    @overload
    def get_int_array(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.IntArrayTag: ...
    @overload
    ...
    def get_int_array(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.IntArrayTag | _T:
    ...
    @overload
    def pop_int_array(self, key: str | bytes, default: _T) -> amulet_nbt.IntArrayTag | _T: ...
    @overload
    def pop_int_array(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.IntArrayTag | _T: ...
    @overload
    def pop_int_array(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.IntArrayTag: ...
    @overload
    ...
    def pop_int_array(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.IntArrayTag | _T:
    ...
    @overload
    def get_long_array(self, key: str | bytes, default: _T) -> amulet_nbt.LongArrayTag | _T: ...
    @overload
    def get_long_array(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.LongArrayTag | _T: ...
    @overload
    def get_long_array(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.LongArrayTag: ...
    @overload
    ...
    def get_long_array(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.LongArrayTag | _T:
    ...
    @overload
    def pop_long_array(self, key: str | bytes, default: _T) -> amulet_nbt.LongArrayTag | _T: ...
    @overload
    def pop_long_array(self, key: str | bytes, default: _T, raise_errors: Literal[False]) -> amulet_nbt.LongArrayTag | _T: ...
    @overload
    def pop_long_array(self, key: str | bytes, default: _T, raise_errors: Literal[True]) -> amulet_nbt.LongArrayTag: ...
    @overload
    ...
    def pop_long_array(self, string key: str | bytes, object default: _T = None, bool raise_errors: bool = False) -> amulet_nbt.LongArrayTag | _T:

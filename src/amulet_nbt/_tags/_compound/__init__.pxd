...
cdef class CompoundTag(AbstractBaseMutableTag):
    ...
    cpdef ListTag get_list(self, str key, ListTag default=*)
    cpdef CompoundTag get_compound(self, str key, CompoundTag default=*)
    ...
    cpdef ListTag setdefault_list(self, str key, ListTag default= *)
    cpdef CompoundTag setdefault_compound(self, str key, CompoundTag default= *)

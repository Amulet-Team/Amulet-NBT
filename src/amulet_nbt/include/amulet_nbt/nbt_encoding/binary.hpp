...
namespace AmuletNBT {
    ...
    std::string write_nbt(BinaryWriter&, const std::string& name, const ByteTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const ShortTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const IntTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const LongTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const FloatTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const DoubleTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const ByteArrayTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const StringTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const ListTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const CompoundTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const IntArrayTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const LongArrayTag&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const std::string& name, const TagNode&, std::endian, StringEncode);
    std::string write_nbt(BinaryWriter&, const NamedTag& tag, std::endian, StringEncode);

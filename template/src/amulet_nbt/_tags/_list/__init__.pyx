...
{{include("AbstractBaseMutableTag.pyx", cls_name="ListTag")}}
...
{{include("ListGet.pyx", tag_cls_name="ListTag", tag_name="list")}}
{{include("ListGet.pyx", tag_cls_name="CompoundTag", tag_name="compound")}}
